<?php  //[STAMP] 631d842d9dcfc38ac0fda5285f2df542
...
trait AcceptanceTesterActions
{
     ...
     *
     * @return void
     * @see \Codeception\Module\WPCLI::haveInShellEnvironment()
     */
    public function haveInShellEnvironment(array $env_vars) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveInShellEnvironment', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \Codeception\Module\WPCLI::dontInheritShellEnvironment()
     */
    public function dontInheritShellEnvironment(array $blocked_env_var_names) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('dontInheritShellEnvironment', func_get_args()));
    }
	 ...
	 * @return void
     * @see \Helper\WPCLI::wpCli()
     */
    public function wpCli(string $command = "") {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('wpCli', func_get_args()));
    }
	 ...
	 * @param string $command Command to run minus 'wp'.
	 * @return string
     * @see \Helper\WPCLI::wpCliToString()
     */
    public function wpCliToString(string $command = ""): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('wpCliToString', func_get_args()));
    }
	 ...
	 * @param string $command Command to run minus 'wp'.
	 * @return array
     * @see \Helper\WPCLI::wpCliToArray()
     */
    public function wpCliToArray(string $command = ""): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('wpCliToArray', func_get_args()));
    }
	 ...
	 *
	 * @return integer
     * @see \Helper\WPCLI::grabLastWpCliExitCode()
     */
    public function grabLastWpCliExitCode(): int {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabLastWpCliExitCode', func_get_args()));
    }
	 ...
	 *
	 * @return string
     * @see \Helper\WPCLI::grabLastWpCliShellOutput()
     */
    public function grabLastWpCliShellOutput(): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabLastWpCliShellOutput', func_get_args()));
    }
}
